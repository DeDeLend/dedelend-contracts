...
export declare class TransactionManager {
    ...
    updateTransactionWithAttempt(txToUpdate: Transaction, tx: StoredTransaction, currentBlock: number): Promise<StoredTransaction>;
    ...
    _resolveNewGasPrice(oldGasPrice: number, minGasPrice: number): {
        newGasPrice: number;
     ...
     */
    boostUnderpricedPendingTransactionsForSigner(signer: string, currentBlockHeight: number, minGasPrice: number): Promise<Map<PrefixedHexString, SignedTransactionDetails>>;
}
